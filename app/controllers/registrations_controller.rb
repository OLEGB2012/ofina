...
private
####################################################################################################################
# Создание тестового предприятия и условного набора данных к нему для только что зарегистрированного пользователя...
  def create_enterprise_data
    ...
    new_enterprise = Enterprise.create!(org_name: 'Для обучения ....', 
                                      ...
                                      vid_econom_deyatel: 'Многопрофильный холдинг' ,
                                      organiz_pravo_form: 'ОАО',
                                      organ_upravlen: 'Концерн среднего и малого машиностроения', 
                                      edinic_izmer: 'млн. рубл.',
                                      adres: 'ул. Первомайская, 140',
                                      K1: 1.5,
                                      K2: 0.2,
                                      K3: 0.85,
    ...
    new_enterprise.form_one_reports << new_form1 
    ...
    new_enterprise.form_two_reports << new_form2
    ...
    new_enterprise.form_three_reports << new_form3

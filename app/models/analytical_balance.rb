...
class AnalyticalBalance < ActiveRecord::Base
  ...
  attr_accessible :date_period_beg, :date_period_end, :ab_type, :row_type, :G1, :G2, :G3, :G5, :G4, :G6, :G8, :G9, :G10
  ...
  scope :KindOfAB,        lambda{|ab_type_value|where("ab_type=?",ab_type_value)}

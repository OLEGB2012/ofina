...
ActiveRecord::Schema.define(:version => 20120825141210) do
  ...
  create_table "users", :force => true do |t|
    ...
    t.date     "dogovor_begin",          :default => '2012-08-29'
    t.date     "dogovor_end",            :default => '2013-08-29'
    t.date     "activation_begin",       :default => '2012-08-29'
    t.date     "activation_end",         :default => '2012-09-13'
